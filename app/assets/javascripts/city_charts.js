...
//salary chart constrcutror instatiation and type= Bar.
  new Chart(salary_chart).Bar(data, {
    segmentStrokeColor: "#82871331"
  });
  ...
  var industry_data = {
    ...
    console.log(industry_xaxis)
    console.log(industry_yaxis)

  new Chart(industry_chart).Bar(industry_data, industry_options);

  //open housing
  var open_housing_chart = $("#open_housing").get(0).getContext("2d");
  var new_open_housing = new Chart(open_housing_chart);

  var open_housing_options = {
  ...
  new Chart(open_housing_chart).Bar(open_housing_data, open_housing_options);
